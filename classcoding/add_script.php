...
<body class="body">
    ...
    <div class="container">
            ...
            <div class="col-xs-8 col-xs-offset-2">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action= "add_script1.php?<?php echo "standard=".$standard?>">
        ...
        <div class="form-group">
        <input  class="form-control" type="number" min="0" id="rollno" name="rollno" placeholder="roll_number"  oninput="validity.valid||(value='');" required="true">
        ...
        <button type="submit" name="submit" class="btn btn-danger">Submit</button><br><br>
                    ...
                    <div class="panel-footer"><p><a href="view1.php?standard=<?php echo $standard ?>">click here </a>to return</p></div>
                </div>
            </div>
        </div>
    </div>
